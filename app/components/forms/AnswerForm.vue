...
<template>
  <div>
    ...
    >
      ...
      <Button
        class="btn light-border-2 text-main-500 dark:text-main-500 flex items-center gap-1.5 rounded-sm px-4 py-2.5 shadow-none"
      ...
      >
        ...
        <template v-else>
          ...
          /> -->
          <Icon name="mdi:stars" class="text-main-500 size-4" />
    ...
    <form class="flex w-full flex-col gap-4" @submit="onSubmit">
      <FormField v-slot="{ value, handleInput, validate }" name="content">
        <FormItem class="flex w-full flex-col gap-3">
          ...
          <FormDescription class="body-regular text-light-500 mt-2.5">
