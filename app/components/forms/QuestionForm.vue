...
<template>
  <form class="flex w-full flex-col gap-10" @submit="onSubmit">
    <FormField v-slot="{ componentField }" name="title">
      <FormItem class="flex w-full flex-col">
        ...
        <FormControl class="mt-3.5">
          <Input
            type="text"
            class="paragraph-regular placeholder text-dark400_light700 bg-light900_dark300 text-dark300_light700 min-h-[56px] border shadow-none outline-none focus:ring-0 focus:outline-none focus-visible:ring-0 focus-visible:ring-transparent"
            v-bind="componentField"
          />
        </FormControl>
        <FormDescription class="body-regular text-light-500 mt-2.5 text-xs">
    ...
    <Button
      type="submit"
      class="primary-gradient !text-light-900 w-fit"
      :disabled="
        status === 'pending' ||
